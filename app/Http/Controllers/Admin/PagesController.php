...
class PagesController extends Controller
{
    ...
    public function getAllSubscribeUsersWeb(){
         ...
         * Start SEO
         */
        SEOMeta::setTitle('Dashboard - All Subscribers - Karimy.ca');
        SEOMeta::setDescription('');
        SEOMeta::setCanonical(URL::current());
        SEOMeta::addKeyword($settings->setting_site_seo_home_keywords);
        /**
        ...
        $subscribers_list = WebsiteSubscribers::all();
         return response()->view('backend.admin.subscribers_list.index',
            compact('subscribers_list'));
    }
}
