                    ...
                    <form method="POST" action="{{ route('admin.plans.update', $plan->id) }}" class="">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea rows="6" placeholder="Please add comma after feature name => Feature1, Feature2, Feature3" id="plan_features" type="text" class="form-control @error('plan_features') is-invalid @enderror" name="plan_features">{{ old('plan_features') ? old('plan_features') : $plan->plan_features }}</textarea>
                                @error('plan_features')
                                <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                    </span>
