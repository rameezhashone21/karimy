                                ...
                                <ul class="list-unstyled mt-3 mb-4">
                                    ...
                                    @if(!empty($plan->plan_features))
                                        ...
                                        @endphp
                                            ...
                                            @foreach ($sep_tag as $tag)
                                             ...
                                             @if($plan->plan_type == \App\Plan::PLAN_TYPE_PAID)
                                        <br/>
                                         @if(trim($tag) == "1 Business listing")
                                          <li >{{$tag}} <br/> <span class="text-muted">(This allows you to list one of the Businesses on the platform)</span></li>
                                         @endif
                                         
                                         @if(trim($tag) == "Unlimited Business")
                                          <li >{{$tag}} <br/> <span class="text-muted">(This allows you to gain as much business as you can from the platform)</span></li>
                                          
                                         @endif
                                         
                                      
                                         <!--@if(trim($tag) == "Listing Features")-->
                                         <!-- <li >{{$tag}} <br/> <span>(This will allow accessing the features for listing)</span></li>-->
                                         <!--@endif-->
                                       ...
                                       @endif
                                             ...
                                             @endforeach                          <li >Listing Features <br/> <span class="text-muted" >(This will allow accessing the features for listing)</span></li>               
                                        <!--<li>-->
                                        <!--    {{ $plan->plan_features }}-->
                                    ...
                                    @if($plan->plan_type == \App\Plan::PLAN_TYPE_FREE)
                                        @if(empty($login_user))
                                            ...
                                            <!--</a>-->
                                            <label> {{ __('frontend.header.free') }}</label>
                                        @else
                                            @if($login_user->isAdmin())
