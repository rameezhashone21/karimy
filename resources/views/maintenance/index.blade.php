...
<head>
    ...
    <title>{{ __('maintenance_mode.seo.title') }}</title>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <span class="display-4 d-block">{{ __('maintenance_mode.title') }}</span>
                <div class="mb-4 lead">{{ __('maintenance_mode.description') }}</div>
            </div>
        </div>
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-7 mb-5 text-center">
                <a class="text-secondary" href="#" data-toggle="modal" data-target="#loginModal">
                    ...
                    {{ __('maintenance_mode.admin-login-modal-title') }}
                </a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('maintenance_mode.admin-login-modal-title') }}</h5>
